  ...
  return (
    <div>
      ...
      <section className="max-w-5xl mx-auto px-4 py-12 space-y-8">
        <p>MyRoofGenius builds protective intelligence systems for commercial roofing professionals who cannot afford to get it wrong. Our AI-native platform combines decades of field experience with real-time analysis to give you clarity and confidence.</p>
