...
export default function GetStarted() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-[var(--color-cloud-100)] to-white flex items-center justify-center p-8">
      {/* replaced blue-50 with cloud-100 token */}
