    ...
    >
      <div className="container mx-auto px-4 py-12 max-w-6xl">
        ...
        <motion.section
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.5 }}
          className="bg-cloud-100 dark:bg-slate-700 rounded-2xl shadow-lg border border-slate-200 dark:border-slate-600 p-8 mb-12"
        >
          <h2 className="text-2xl font-semibold mb-8 text-center">
            What Our Field Apps Protect
          </h2>
        ...
        >
          ...
          <Link
            href="/get-started"
            className="inline-block bg-secondary-700 text-white px-8 py-3 rounded-lg font-semibold hover:bg-secondary-700/80 transition-colors"
          >
            Start Protecting Your Jobs
          </Link>
        </motion.section>
      </div>
    </motion.div>
