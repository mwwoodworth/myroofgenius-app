...
const Dashboard3D = loadDynamic(() => import("@/components/Dashboard3D"), {
  ssr: false,
});
...
export const generateMetadata = () =>
  buildMeta({
    title: "Dashboard | MyRoofGenius",
    description: "Overview of your projects, orders and analytics.",
  });
...
async function getDashboardData() {
  ...
  const downloads =
    downloadsRes.status === "fulfilled" ? downloadsRes.value.data : null;
  const analyses =
    analysesRes.status === "fulfilled" ? analysesRes.value.data : null;
  const tickets =
    ticketsRes.status === "fulfilled" ? ticketsRes.value.data : null;
  const favorites =
                    ...
                    {data.charts.monthlySpending.map((month, idx) => (
                      ...
                      >
                        ...
                        <p className="text-xs text-gray-600 mt-2">
                          {new Date(month.month).toLocaleDateString("en", {
                            month: "short",
                          })}
                        </p>
                      </div>
              ...
              <div className="p-6">
                {data.licenses.length === 0 ? (
                  ...
                  <div className="space-y-2">
                    {data.licenses.map(
                      (lic: { id: string; license_key: string }) => (
                        <div
                          key={lic.id}
              ...
              <div className="p-6">
                {data.analyses.length === 0 ? (
                  <p className="text-gray-600 text-sm">
                    ...
                    <Link
                      href="/estimator"
                      className="text-secondary-700 hover:underline ml-1"
                    >
                      Try AI estimator
                    </Link>
                  </p>
          ...
          <div className="mt-8 bg-gradient-to-r from-[var(--color-primary)] to-[color-mix(in_srgb,var(--color-primary)_80%,black)] rounded-lg p-8 text-white">
            ...
            <div className="max-w-3xl">
              ...
              <p className="text-secondary-700/20 mb-4">
                Get unlimited AI analyses, priority support, and exclusive
                templates
              </p>
              <Link
                href="/pricing"
